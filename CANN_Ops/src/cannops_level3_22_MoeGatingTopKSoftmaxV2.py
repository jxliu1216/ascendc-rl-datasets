...
def get_input_groups():
    json_path = os.path.join(os.path.dirname(__file__), 'cannops_level3_22_MoeGatingTopKSoftmaxV2.json')
    ...
    for case in cases:
        ...
        k = k_info["value"]
        renorm = renorm_info["value"]

        input_groups.append([x, finished_optional, k, renorm])
    return input_groups
