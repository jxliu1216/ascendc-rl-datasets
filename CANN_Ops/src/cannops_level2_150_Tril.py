...
def get_input_groups():
    json_path = os.path.join(os.path.dirname(__file__), 'cannops_level2_150_Tril.json')
    ...
    for case in cases:
        ...
        diagonal = torch.randint(diagonal_info["range"][0], diagonal_info["range"][1] + 1, (1,)).item()
